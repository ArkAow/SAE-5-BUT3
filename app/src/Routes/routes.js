...
const routes = {
  dev: {
    ...
    courses: {
      ...
      addByHalfGroup: () => `${routes.dev.default}courses/add/half_group`,
      addByGroup: () => `${routes.dev.default}courses/add/group`,
      addByFormationLevel: () => `${routes.dev.default}courses/add/formationlevel`,
